...
class ProjectDetailsRepositoryImpl(
    ...
    override fun projectDetails(id: String): Flow<StateData<ProjectDetailsQuery.Data.PagePage.ProjectHeaderBlock.Entity>> =
        dataSource.read(
...
private fun ProjectDetailsQuery.request(forceRefresh: Boolean = true) =
